...
## Overview
Slot range: [352512000, 358560000]
### Global Metrics
|Metric|Value|
|---|---|
|Proportion of sandwich-inclusive block|1.673%|
|Average sandwiches per block|0.01857|
|Standard Deviation of sandwiches per block|0.15216|

### Stake pool dsitribution (Epoch 830):
|Pool|Stake (SOL)|Pool Share|
|---|---|---|
|Marinade (overall)|914,158|18.79%|
| - Marinade Liquid|463,840|19.62%|
| - Marinade Native|450,318|18.01%|
|Jito|3,145,693|22.89%|
|SFDP|1,276,979|3.63%|
|JPool|25,400|2.11%|
|BlazeStake|18,690|1.57%|
|Firedancer|20,058|1.05%|
|DZDP|21,792|0.72%|
|xSHIN|3,363|0.33%|
|marginfi|42|0.03%|
...
|---|---|---|---|---|
|Haus – Guaranteed Best APY & No Fees|2,005,679|29,608|915.00|983.83|
|AG 0% fee + ALL MEV profit share|1,404,004|20,640|1,378.83|1,464.33|
|[Marinade Customer] 🧬 HelixNode jitoMEV 0% fee 🧬|394,070|5,920|329.33|343.17|
|Bluestone 💙|225,407|3,704|130.50|144.58|
|Wexel|216,073|3,364|214.17|237.42|
